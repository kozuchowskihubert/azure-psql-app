...
console.log('📱 App.js: After StatusBar import');
import React, { useEffect, useState } from 'react';
console.log('📱 App.js: After React import');
import { Text, View } from 'react-native';
console.log('📱 App.js: After react-native imports');
import { NavigationContainer } from '@react-navigation/native';
import { createStackNavigator } from '@react-navigation/stack';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { WebAudioBridgeComponent } from './src/audio/WebAudioBridge';
console.log('📱 App.js: After all infrastructure imports');

// NEW REFACTOR - SSO Persona & Main Navigation
import WelcomeScreen from './src/screens/WelcomeScreen';
console.log('📱 App.js: After WelcomeScreen import');
import MainTabNavigator from './src/navigation/MainTabNavigator';
console.log('📱 App.js: After MainTabNavigator import');
